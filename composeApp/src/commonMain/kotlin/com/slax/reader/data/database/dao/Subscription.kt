        ...
        """.trimIndent(),
            ...
            mapper = { cursor ->
                UserSubscriptionInfo(
                    ...
                    first_subscription_time = cursor.getStringOptional("first_subscription_time")?.toLongOrNull() ?: 0L,
                    subscription_end_time = cursor.getStringOptional("subscription_end_time")?.toLongOrNull() ?: 0L,
                    next_invoice_time = cursor.getStringOptional("next_invoice_time")?.toLongOrNull() ?: 0L,
